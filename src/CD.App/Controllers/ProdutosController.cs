...
namespace CD.App.Controllers
{
    public class ProdutosController : BaseController
    {
        ...
        public ProdutosController(IProdutoRepository produtoRepository, IFornecedorRepository fornecedorRepository, IMapper mapper, IProdutoService produtoService)
        {
        ...
        private async Task<bool> UploadArquivo(IFormFile imagemUpload, string imgPrefixo)
        {
            ...
            var path = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot/img", imgPrefixo + imagemUpload.FileName);
